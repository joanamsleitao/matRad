...
% Termination (C.2)
            ...
            obj.options.acceptable_iter               = 15;    % (Acc1)
            obj.options.acceptable_tol                = 1e10; % (Acc2) % was 1e10
            obj.options.acceptable_constr_viol_tol    = 1e-4; % (Acc3)
            ...
            obj.options.max_iter                      = 250; % matRad_cfg.defaults.propOpt.maxIter; % was 500! Joana, 16072025
            obj.options.max_cpu_time                  = 600;
