function [ct, cst, pln, stf, resultGUI, doseCube] = matRad_dataImpPat(patientName, inputPath, varargin)
% matRad_dataImpPat - Unified patient data import for matRad
% -------------------------------------------------------------------------
...
%   [ct, cst, pln, stf, resultGUI, doseCube] = matRad_dataImpPat('Patient01', 'Patient01.mat');
%
%   % Example 2: Load a folder of MAT files matching a plan
%   [ct, cst, pln, stf, resultGUI, doseCube] = matRad_dataImpPat('Patient01', 'PatientFolder', ...
%                                      'matchPattern', 'PlanA');
%
%   % Example 3: Load a DICOM folder with fallback DICOMs
%   [ct, cst, pln, stf, resultGUI, doseCube] = matRad_dataImpPat('Patient01', 'DICOM_Folder', ...
%                                      'matchPattern', 'PlanA', ...
