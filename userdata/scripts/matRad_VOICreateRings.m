function [cst, ringInfo] = matRad_VOICreateRings(ct, cst, ring_mm, ixRefVOI, marginPTVRing_mm, visualize)
% matRad_VOICreateRings - Create concentric ring VOIs around reference structure
%
