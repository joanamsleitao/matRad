function [cst, qi] = matRadJoana_replicateCstFromDoseCube(cst, pln, doseCube, prescribedDose, penalty, refGy, refVol)
...
for StructNr = 1:size(cst,1)
    if strcmp(cst{StructNr,3}, 'TARGET')
        ...
        cst{StructNr,6}{1}.penalty = 1000; % struct(DoseObjectives.matRad_MeanDose(penalty, MeanDose(g)));
