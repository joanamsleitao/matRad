function matRad_evalFLASH(beamSearch, cst, ptvAlias, flashAlias, oarAliases, prescribedDose)
% EVALUATEFLASHPLANS - Evaluate multiple FLASH proton plans by metrics
%
% Syntax:
%   matRad_evalFLASH(beamSearch, cst, ptvAlias, flashAlias, oarAliases, prescribedDose)
%
% Inputs:
