function [cst, newIx] = matRad_VOIOps(cst, ix1, ix2, operation, newName)
% matRad_VOIOps Combine voxel indices from two VOIs in CST with set operations
%
% [cst, newIx] = matRad_VOIOps(cst, ix1, ix2, operation, newName)
%
% Inputs:
%   cst       - CST cell array
