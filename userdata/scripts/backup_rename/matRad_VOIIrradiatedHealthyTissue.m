function [cstNew, healthyMask, healthyAboveThrMask] = matRad_VOIIrradiatedHealthyTissue( ...
    cst, doseCube, doseThreshold, includeTargets)
% matRad_VOIIrradiatedHealthyTissue - Create VOIs for irradiated healthy tissue
%
% Syntax:
%   [cstNew, healthyMask, healthyAboveThrMask] = ...
%       matRad_VOIIrradiatedHealthyTissue(cst, doseCube, doseThreshold, includeTargets)
%
% Description:
