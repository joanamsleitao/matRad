function [doseCubeMod, maskStruct, cstOut] = matRad_FLASHDMFPipeline( ...
    cst, doseCube, DMF, voiSelection, doseThreshold, outputTxtFile, ...
    includeHealthyTissue, returnMasks, applyMode)
% matRad_FLASHDMFPipeline - Apply FLASH Dose Modifying Factor (DMF)
...
%
% SYNTAX:
%   [doseCubeMod, maskStruct, cstOut] = matRad_FLASHDMFPipeline( ...
...
doseAboveThrMask = matRad_VOIDoseThresholdMask(cstOut, doseCube, voiSelection, doseThreshold, true);
