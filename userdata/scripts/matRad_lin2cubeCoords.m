function [targetIndex_i,targetIndex_j,targetIndex_k] = matRad_lin2cubeCoords(cubeDim, indices)
...
[targetIndex_i,targetIndex_j,targetIndex_k] = ind2sub(cubeDim, indices);
