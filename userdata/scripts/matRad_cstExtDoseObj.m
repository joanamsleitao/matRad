function [metricStrings, objStruct] = matRad_cstExtDoseObj(cst, VOIs)
% matRad_cstExtDoseObj
% -------------------------------------------------------------------------
...
% -------------------------------------------------------------------------
% Syntax:
%   [metricStrings, objStruct] = matRad_cstExtDoseObj(cst, VOIs)
%
% Inputs:
...
%
% Example:
%   [strings, structOut] = matRad_cstExtDoseObj(cst);
%
%   structOut(1)
%       .VOIName = 'PTV'
%       .isTarget = true
