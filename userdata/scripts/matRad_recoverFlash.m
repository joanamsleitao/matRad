function [doseFLASH, doseDiff, flashMask] = matRad_recoverFlash(ct, cst, doseEff, DMF, FLASHthresh, doPlot)
% matRad_recoverFlash
...
% DMF = 2;
% FLASHthresh = 10;
% [doseFLASH, flashMask] = matRad_recoverFlash(ct, cst, doseFLASH, DMF, FLASHthresh, 1);
% INPUTS
%   ct         - CT struct
