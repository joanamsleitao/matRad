...
figure;
ax5 = gca;
matRad_plotEnergyLayerWeightsHistogram(ax5, stf, 'perRay');   % Shows ray-level stacking

%%
figure;
ax6 = gca;
matRad_plotEnergyLayerWeightsHistogram(ax6, stf, 'perBeam');  % Default, as before
% =========================================================================
% End of example
% =========================================================================