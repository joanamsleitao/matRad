function [ct, cst, doseCube] = matRad_loadOrImportDicom(patientName, wildcard)
% matRad_loadOrImportDicom - Load patient CT, CST, and dose data from .mat or DICOM
%
% Syntax:
%   [ct, cst, resultGUI] = matRad_loadOrImportDicom(patientName)
%   [ct, cst, resultGUI] = matRad_loadOrImportDicom(patientName, wildcard)
%
% Inputs:
