function [ct, cst, pln, stf, resultGUI] = matRad_dicomPath(inputPath, secondPath)
% matRad_dicomPath - Imports DICOM data from a primary folder,
% optionally using a fallback folder if CT or RTSTRUCT are missing.
%
% USAGE:
%   [ct, cst, pln, stf, resultGUI] = matRad_dicomPath(inputPath)
%   [ct, cst, pln, stf, resultGUI] = matRad_dicomPath(inputPath, secondPath)
%
% INPUTS:
