function [ct, cst, doseCube] = matRad_dataImp(patientName, searchPath, matchPattern)
% matRad_dataImp - Load CT, CST, and doseCube from .mat or DICOM data.
%
% Syntax:
%   [ct, cst, doseCube] = matRad_dataImp(patientName, searchPath, matchPattern)
%
% Inputs:
