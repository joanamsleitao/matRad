function [doseFLASH, flashMask, report] = matRad_detectFLASH(doseEff, cst, ixTarget, varargin)
...
%
% Syntax:
%   [doseFLASH, flashMask, report] = matRad_detectFLASH(doseEff, cst, ixTarget)
%   [doseFLASH, flashMask, report] = matRad_detectFLASH(..., 'DMF', 2.0, 'DoseThr', 10, ...
...
%
% Example:
%   [doseFLASH, mask, rep] = matRad_detectFLASH(doseEff, cst, [ixGTV ixPTV], 'Method','valley',...
